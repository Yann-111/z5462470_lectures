...
new_delta  = dt.datetime(year=2019, month=12, day=31, hour=12) - dt.datetime(year=2019, month=12, day=31, hour=0)
#print(new_delta)
...
date  = dt.datetime(year=2019, month=12, day=31, hour=0)

# Create a string with the representation we want:
s  = date.strftime('%Y-%B-%d')
#print(s)
